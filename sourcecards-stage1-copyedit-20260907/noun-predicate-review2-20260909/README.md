...
| 선진 22 | 스승이 살아 있는 한 곁으로 돌아가야 했으므로, 위험을 피하는 것도 안회에게는 할 일이었습니다. | 스승이 살아 있는 한 곁으로 돌아가야 했으므로, 안회는 위험도 피해야 했습니다. |
| 자로 15 | 왕의 말이 늘 옳아서 조용한 것인지, 잘못을 알아도 말할 수 없어 조용한 것인지는 전혀 다른 일이었습니다. | 왕의 말이 늘 옳아서 조용한 것과, 잘못을 알아도 말할 수 없어 조용한 것은 전혀 달랐습니다. |
| 양화 12 | 위세로 없는 것을 있는 척하는 태도입니다. | 공자는 위세로 없는 것을 있는 척하는 태도를 꾸짖었습니다. |

자연스러운 인물 소개·용어 정의·출처 표시는 유지했습니다. 인과·대비를 살리고, 해야 할 일을 실제로 했다는 뜻으로 바꾸지 않았습니다.
